...
public class DrawerGenMpinActivity extends MyBaseActivity {
    ...
    static String URL_MPIN="https://malamaal.anshuwap.com/restApi/randstring.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(DrawerGenMpinActivity.this);
    ...
    protected void onStart() {
        super.onStart();
        setSessionTimeOut(DrawerGenMpinActivity.this);
    }
                    ...
                    public void onResponse(String response) {
                        ...
                        try
                        {
                            ...
                            else if(status.equals("unsuccessful"))
                            {
                                progressDialog.dismiss();
                                String mpin=jsonObject.getString("ans");
                            details.errorMessageDialog(DrawerGenMpinActivity.this,""+mpin);
                            }
                            else
                            {
